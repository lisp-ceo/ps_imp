...
(function(exports) {
  ...
  var writeToCanvas = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect.monadEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(Effect.monadEffect)(Graphics_Canvas.getCanvasElementById("canvas")))(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 32, column 3 - line 42, column 1): " + [ v.constructor.name ]);
  });
  var reportResult = function (window) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 42, column 1 - line 42, column 62): " + [ window.constructor.name, v.constructor.name ]);
      };
  };
  var main = function __do() {
      var v = Web_HTML.window();
      return Control_Bind.bind(Effect.bindEffect)(Control_Monad_Except_Trans.runExceptT(writeToCanvas))(reportResult(v))();
  };
  exports["main"] = main;
